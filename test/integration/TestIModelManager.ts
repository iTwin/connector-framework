 ...
 * */
  public async createIModel(accessToken: AccessToken): Promise<string> {
    ...
    this._modelIdCreated = await IModelHost.hubAccess.createNewIModel({ accessToken, iTwinId: this._iTwinId, iModelName: currName });
 ...
 * @name deleteIModel
 * @param accessToken */
  public async deleteIModel(accessToken: AccessToken) {
