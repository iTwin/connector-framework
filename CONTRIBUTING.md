...
Have a question?
Rather than opening an issue, please ask away on [the Github discussions page](https://github.com/iTwin/connector-framework/discussions).
...
Your comments and feedback are welcome. For general comments or discussion please [click here](https://github.com/iTwin/connector-framework/labels/discussions) to contribute via GitHub issues using the `discussion` label.
...
Before you create a new issue, please do a search in [open issues](https://github.com/iTwin/connector-framework/issues) to see if the issue or feature request has already been filed.
...
- Impact of the issue
- Use the [`bug`](https://github.com/iTwin/connector-framework/labels/bug) or [`enhancement`](https://github.com/iTwin/connector-framework/labels/enhancements) label to identify the type of issue you are filing
